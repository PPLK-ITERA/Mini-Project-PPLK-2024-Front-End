...
const Page = () => {
  return (
    <div className="py-1 sm:pt-3 sm:pb-24 bg-center bg-cover relative">
      <Image src="/assets/background-quiz.png" alt="bg" width={425} height={601} quality={100} className="absolute inset-0
      w-full h-full -z-10 zoom-in-50 object-top bg-jaffa-400 " />
